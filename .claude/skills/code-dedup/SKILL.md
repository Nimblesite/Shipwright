...
4. Check across module boundaries — duplicates often hide between `deploy-toolkit-host` and any future workspace members.
...
- **Preserve public API surface.** `crates/deploy-toolkit-host` is a published library. Do not change function signatures, struct names, or module exports. Internal refactoring only.
